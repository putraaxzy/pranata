...
// 1. DEFINISIKAN DAY_LABELS AGAR TIDAK ERROR REFERENCE
...
interface Schedule {
  ...
  end_date?: string
  completed_dates?: string[] // Tambahan
  is_done?: boolean // Tambahan
  exception_dates?: string[] // Tambahan
  displayTime?: string
